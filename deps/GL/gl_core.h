...
typedef unsigned int GLhandleARB;
		...
		//GL_STACK_OVERFLOW seen in KHR_debug
		//GL_STACK_UNDERFLOW seen in KHR_debug
		...
		//GL_COMPATIBLE_SUBROUTINES seen in ARB_program_interface_query
		...
		//GL_NUM_COMPATIBLE_SUBROUTINES seen in ARB_program_interface_query
		...
		//GL_TEXTURE_CUBE_MAP_ARRAY seen in ARB_internalformat_query2
		...
		// Version: 4.1
		//GL_ACTIVE_PROGRAM seen in ARB_separate_shader_objects
		//GL_ALL_SHADER_BITS seen in ARB_separate_shader_objects
		//GL_FIXED seen in ARB_ES2_compatibility
		//GL_FRAGMENT_SHADER_BIT seen in ARB_separate_shader_objects
		//GL_GEOMETRY_SHADER_BIT seen in ARB_separate_shader_objects
		//GL_HIGH_FLOAT seen in ARB_ES2_compatibility
		//GL_HIGH_INT seen in ARB_ES2_compatibility
		//GL_IMPLEMENTATION_COLOR_READ_FORMAT seen in ARB_ES2_compatibility
		//GL_IMPLEMENTATION_COLOR_READ_TYPE seen in ARB_ES2_compatibility
		//GL_LAYER_PROVOKING_VERTEX seen in ARB_viewport_array
		//GL_LOW_FLOAT seen in ARB_ES2_compatibility
		//GL_LOW_INT seen in ARB_ES2_compatibility
		//GL_MAX_FRAGMENT_UNIFORM_VECTORS seen in ARB_ES2_compatibility
		//GL_MAX_VARYING_VECTORS seen in ARB_ES2_compatibility
		//GL_MAX_VERTEX_UNIFORM_VECTORS seen in ARB_ES2_compatibility
		//GL_MAX_VIEWPORTS seen in ARB_viewport_array
		//GL_MEDIUM_FLOAT seen in ARB_ES2_compatibility
		//GL_MEDIUM_INT seen in ARB_ES2_compatibility
		//GL_NUM_PROGRAM_BINARY_FORMATS seen in ARB_get_program_binary
		//GL_NUM_SHADER_BINARY_FORMATS seen in ARB_ES2_compatibility
		//GL_PROGRAM_BINARY_FORMATS seen in ARB_get_program_binary
		//GL_PROGRAM_BINARY_LENGTH seen in ARB_get_program_binary
		//GL_PROGRAM_BINARY_RETRIEVABLE_HINT seen in ARB_get_program_binary
		//GL_PROGRAM_PIPELINE_BINDING seen in ARB_separate_shader_objects
		//GL_PROGRAM_SEPARABLE seen in ARB_separate_shader_objects
		//GL_RGB565 seen in ARB_ES2_compatibility
		//GL_SHADER_BINARY_FORMATS seen in ARB_ES2_compatibility
		//GL_SHADER_COMPILER seen in ARB_ES2_compatibility
		//GL_TESS_CONTROL_SHADER_BIT seen in ARB_separate_shader_objects
		//GL_TESS_EVALUATION_SHADER_BIT seen in ARB_separate_shader_objects
		//GL_UNDEFINED_VERTEX seen in ARB_viewport_array
		//GL_VERTEX_SHADER_BIT seen in ARB_separate_shader_objects
		//GL_VIEWPORT_BOUNDS_RANGE seen in ARB_viewport_array
		//GL_VIEWPORT_INDEX_PROVOKING_VERTEX seen in ARB_viewport_array
		//GL_VIEWPORT_SUBPIXEL_BITS seen in ARB_viewport_array
		
		// Version: 4.2
		#define GL_ACTIVE_ATOMIC_COUNTER_BUFFERS 0x92D9
		#define GL_ALL_BARRIER_BITS              0xFFFFFFFF
		#define GL_ATOMIC_COUNTER_BARRIER_BIT    0x00001000
		//GL_ATOMIC_COUNTER_BUFFER seen in ARB_program_interface_query
		...
		//GL_IMAGE_FORMAT_COMPATIBILITY_TYPE seen in ARB_internalformat_query2
		...
		//GL_MIN_MAP_BUFFER_ALIGNMENT seen in ARB_map_buffer_alignment
		//GL_NUM_SAMPLE_COUNTS seen in ARB_internalformat_query2
		//GL_PACK_COMPRESSED_BLOCK_DEPTH seen in ARB_compressed_texture_pixel_storage
		//GL_PACK_COMPRESSED_BLOCK_HEIGHT seen in ARB_compressed_texture_pixel_storage
		//GL_PACK_COMPRESSED_BLOCK_SIZE seen in ARB_compressed_texture_pixel_storage
		//GL_PACK_COMPRESSED_BLOCK_WIDTH seen in ARB_compressed_texture_pixel_storage
		#define GL_PIXEL_BUFFER_BARRIER_BIT      0x00000080
		#define GL_SHADER_IMAGE_ACCESS_BARRIER_BIT 0x00000020
		#define GL_TEXTURE_FETCH_BARRIER_BIT     0x00000008
		//GL_TEXTURE_IMMUTABLE_FORMAT seen in ARB_texture_storage
		#define GL_TEXTURE_UPDATE_BARRIER_BIT    0x00000100
		#define GL_TRANSFORM_FEEDBACK_BARRIER_BIT 0x00000800
		#define GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX 0x92DA
		#define GL_UNIFORM_BARRIER_BIT           0x00000004
		//GL_UNPACK_COMPRESSED_BLOCK_DEPTH seen in ARB_compressed_texture_pixel_storage
		//GL_UNPACK_COMPRESSED_BLOCK_HEIGHT seen in ARB_compressed_texture_pixel_storage
		//GL_UNPACK_COMPRESSED_BLOCK_SIZE seen in ARB_compressed_texture_pixel_storage
		//GL_UNPACK_COMPRESSED_BLOCK_WIDTH seen in ARB_compressed_texture_pixel_storage
		...
		// Version: 4.3
		//GL_ACTIVE_RESOURCES seen in ARB_program_interface_query
		//GL_ACTIVE_VARIABLES seen in ARB_program_interface_query
		//GL_ANY_SAMPLES_PASSED_CONSERVATIVE seen in ARB_ES3_compatibility
		//GL_ARRAY_SIZE seen in ARB_program_interface_query
		//GL_ARRAY_STRIDE seen in ARB_program_interface_query
		//GL_ATOMIC_COUNTER_BUFFER_INDEX seen in ARB_program_interface_query
		#define GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_COMPUTE_SHADER 0x90ED
		//GL_AUTO_GENERATE_MIPMAP seen in ARB_internalformat_query2
		//GL_BLOCK_INDEX seen in ARB_program_interface_query
		//GL_BUFFER seen in KHR_debug
		//GL_BUFFER_BINDING seen in ARB_program_interface_query
		//GL_BUFFER_DATA_SIZE seen in ARB_program_interface_query
		//GL_BUFFER_VARIABLE seen in ARB_program_interface_query
		//GL_CAVEAT_SUPPORT seen in ARB_internalformat_query2
		//GL_CLEAR_BUFFER seen in ARB_internalformat_query2
		//GL_COLOR_COMPONENTS seen in ARB_internalformat_query2
		//GL_COLOR_ENCODING seen in ARB_internalformat_query2
		//GL_COLOR_RENDERABLE seen in ARB_internalformat_query2
		//GL_COMPRESSED_R11_EAC seen in ARB_ES3_compatibility
		//GL_COMPRESSED_RG11_EAC seen in ARB_ES3_compatibility
		//GL_COMPRESSED_RGB8_ETC2 seen in ARB_ES3_compatibility
		//GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2 seen in ARB_ES3_compatibility
		//GL_COMPRESSED_RGBA8_ETC2_EAC seen in ARB_ES3_compatibility
		//GL_COMPRESSED_SIGNED_R11_EAC seen in ARB_ES3_compatibility
		//GL_COMPRESSED_SIGNED_RG11_EAC seen in ARB_ES3_compatibility
		//GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC seen in ARB_ES3_compatibility
		//GL_COMPRESSED_SRGB8_ETC2 seen in ARB_ES3_compatibility
		//GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2 seen in ARB_ES3_compatibility
		#define GL_COMPUTE_LOCAL_WORK_SIZE       0x8267
		#define GL_COMPUTE_SHADER                0x91B9
		//GL_COMPUTE_SUBROUTINE seen in ARB_program_interface_query
		//GL_COMPUTE_SUBROUTINE_UNIFORM seen in ARB_program_interface_query
		//GL_COMPUTE_TEXTURE seen in ARB_internalformat_query2
		//GL_CONTEXT_FLAG_DEBUG_BIT seen in KHR_debug
		//GL_DEBUG_CALLBACK_FUNCTION seen in KHR_debug
		//GL_DEBUG_CALLBACK_USER_PARAM seen in KHR_debug
		//GL_DEBUG_GROUP_STACK_DEPTH seen in KHR_debug
		//GL_DEBUG_LOGGED_MESSAGES seen in KHR_debug
		//GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH seen in KHR_debug
		//GL_DEBUG_OUTPUT seen in KHR_debug
		//GL_DEBUG_OUTPUT_SYNCHRONOUS seen in KHR_debug
		//GL_DEBUG_SEVERITY_HIGH seen in KHR_debug
		//GL_DEBUG_SEVERITY_LOW seen in KHR_debug
		//GL_DEBUG_SEVERITY_MEDIUM seen in KHR_debug
		//GL_DEBUG_SEVERITY_NOTIFICATION seen in KHR_debug
		//GL_DEBUG_SOURCE_API seen in KHR_debug
		//GL_DEBUG_SOURCE_APPLICATION seen in KHR_debug
		//GL_DEBUG_SOURCE_OTHER seen in KHR_debug
		//GL_DEBUG_SOURCE_SHADER_COMPILER seen in KHR_debug
		//GL_DEBUG_SOURCE_THIRD_PARTY seen in KHR_debug
		//GL_DEBUG_SOURCE_WINDOW_SYSTEM seen in KHR_debug
		//GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR seen in KHR_debug
		//GL_DEBUG_TYPE_ERROR seen in KHR_debug
		//GL_DEBUG_TYPE_MARKER seen in KHR_debug
		//GL_DEBUG_TYPE_OTHER seen in KHR_debug
		//GL_DEBUG_TYPE_PERFORMANCE seen in KHR_debug
		//GL_DEBUG_TYPE_POP_GROUP seen in KHR_debug
		//GL_DEBUG_TYPE_PORTABILITY seen in KHR_debug
		//GL_DEBUG_TYPE_PUSH_GROUP seen in KHR_debug
		//GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR seen in KHR_debug
		//GL_DEPTH_COMPONENTS seen in ARB_internalformat_query2
		//GL_DEPTH_RENDERABLE seen in ARB_internalformat_query2
		//GL_DEPTH_STENCIL_TEXTURE_MODE seen in ARB_stencil_texturing
		#define GL_DISPATCH_INDIRECT_BUFFER      0x90EE
		#define GL_DISPATCH_INDIRECT_BUFFER_BINDING 0x90EF
		//GL_FILTER seen in ARB_internalformat_query2
		//GL_FRAGMENT_SUBROUTINE seen in ARB_program_interface_query
		//GL_FRAGMENT_SUBROUTINE_UNIFORM seen in ARB_program_interface_query
		//GL_FRAGMENT_TEXTURE seen in ARB_internalformat_query2
		//GL_FRAMEBUFFER_BLEND seen in ARB_internalformat_query2
		//GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS seen in ARB_framebuffer_no_attachments
		//GL_FRAMEBUFFER_DEFAULT_HEIGHT seen in ARB_framebuffer_no_attachments
		//GL_FRAMEBUFFER_DEFAULT_LAYERS seen in ARB_framebuffer_no_attachments
		//GL_FRAMEBUFFER_DEFAULT_SAMPLES seen in ARB_framebuffer_no_attachments
		//GL_FRAMEBUFFER_DEFAULT_WIDTH seen in ARB_framebuffer_no_attachments
		//GL_FRAMEBUFFER_RENDERABLE seen in ARB_internalformat_query2
		//GL_FRAMEBUFFER_RENDERABLE_LAYERED seen in ARB_internalformat_query2
		//GL_FULL_SUPPORT seen in ARB_internalformat_query2
		//GL_GEOMETRY_SUBROUTINE seen in ARB_program_interface_query
		//GL_GEOMETRY_SUBROUTINE_UNIFORM seen in ARB_program_interface_query
		//GL_GEOMETRY_TEXTURE seen in ARB_internalformat_query2
		//GL_GET_TEXTURE_IMAGE_FORMAT seen in ARB_internalformat_query2
		//GL_GET_TEXTURE_IMAGE_TYPE seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_10_10_10_2 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_11_11_10 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_1_X_16 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_1_X_32 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_1_X_8 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_2_X_16 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_2_X_32 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_2_X_8 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_4_X_16 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_4_X_32 seen in ARB_internalformat_query2
		//GL_IMAGE_CLASS_4_X_8 seen in ARB_internalformat_query2
		//GL_IMAGE_COMPATIBILITY_CLASS seen in ARB_internalformat_query2
		//GL_IMAGE_PIXEL_FORMAT seen in ARB_internalformat_query2
		//GL_IMAGE_PIXEL_TYPE seen in ARB_internalformat_query2
		//GL_IMAGE_TEXEL_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_ALPHA_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_ALPHA_TYPE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_BLUE_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_BLUE_TYPE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_DEPTH_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_DEPTH_TYPE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_GREEN_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_GREEN_TYPE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_PREFERRED seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_RED_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_RED_TYPE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_SHARED_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_STENCIL_SIZE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_STENCIL_TYPE seen in ARB_internalformat_query2
		//GL_INTERNALFORMAT_SUPPORTED seen in ARB_internalformat_query2
		//GL_IS_PER_PATCH seen in ARB_program_interface_query
		//GL_IS_ROW_MAJOR seen in ARB_program_interface_query
		//GL_LOCATION seen in ARB_program_interface_query
		//GL_LOCATION_INDEX seen in ARB_program_interface_query
		//GL_MANUAL_GENERATE_MIPMAP seen in ARB_internalformat_query2
		//GL_MATRIX_STRIDE seen in ARB_program_interface_query
		#define GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS 0x8266
		//GL_MAX_COMBINED_DIMENSIONS seen in ARB_internalformat_query2
		...
		//GL_MAX_DEBUG_GROUP_STACK_DEPTH seen in KHR_debug
		//GL_MAX_DEBUG_LOGGED_MESSAGES seen in KHR_debug
		//GL_MAX_DEBUG_MESSAGE_LENGTH seen in KHR_debug
		//GL_MAX_DEPTH seen in ARB_internalformat_query2
		//GL_MAX_ELEMENT_INDEX seen in ARB_ES3_compatibility
		#define GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS 0x90DA
		//GL_MAX_FRAMEBUFFER_HEIGHT seen in ARB_framebuffer_no_attachments
		//GL_MAX_FRAMEBUFFER_LAYERS seen in ARB_framebuffer_no_attachments
		//GL_MAX_FRAMEBUFFER_SAMPLES seen in ARB_framebuffer_no_attachments
		//GL_MAX_FRAMEBUFFER_WIDTH seen in ARB_framebuffer_no_attachments
		#define GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS 0x90D7
		//GL_MAX_HEIGHT seen in ARB_internalformat_query2
		//GL_MAX_LABEL_LENGTH seen in KHR_debug
		//GL_MAX_LAYERS seen in ARB_internalformat_query2
		//GL_MAX_NAME_LENGTH seen in ARB_program_interface_query
		//GL_MAX_NUM_ACTIVE_VARIABLES seen in ARB_program_interface_query
		//GL_MAX_NUM_COMPATIBLE_SUBROUTINES seen in ARB_program_interface_query
		#define GL_MAX_SHADER_STORAGE_BLOCK_SIZE 0x90DE
		#define GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS 0x90DD
		#define GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS 0x90D8
		#define GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS 0x90D9
		//GL_MAX_UNIFORM_LOCATIONS seen in ARB_explicit_uniform_location
		//GL_MAX_VERTEX_ATTRIB_BINDINGS seen in ARB_vertex_attrib_binding
		//GL_MAX_VERTEX_ATTRIB_RELATIVE_OFFSET seen in ARB_vertex_attrib_binding
		#define GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS 0x90D6
		//GL_MAX_WIDTH seen in ARB_internalformat_query2
		//GL_MIPMAP seen in ARB_internalformat_query2
		//GL_NAME_LENGTH seen in ARB_program_interface_query
		//GL_NUM_ACTIVE_VARIABLES seen in ARB_program_interface_query
		#define GL_NUM_SHADING_LANGUAGE_VERSIONS 0x82E9
		//GL_OFFSET seen in ARB_program_interface_query
		//GL_PRIMITIVE_RESTART_FIXED_INDEX seen in ARB_ES3_compatibility
		//GL_PROGRAM seen in KHR_debug
		//GL_PROGRAM_INPUT seen in ARB_program_interface_query
		//GL_PROGRAM_OUTPUT seen in ARB_program_interface_query
		//GL_PROGRAM_PIPELINE seen in KHR_debug
		//GL_QUERY seen in KHR_debug
		//GL_READ_PIXELS seen in ARB_internalformat_query2
		//GL_READ_PIXELS_FORMAT seen in ARB_internalformat_query2
		//GL_READ_PIXELS_TYPE seen in ARB_internalformat_query2
		//GL_REFERENCED_BY_COMPUTE_SHADER seen in ARB_program_interface_query
		//GL_REFERENCED_BY_FRAGMENT_SHADER seen in ARB_program_interface_query
		//GL_REFERENCED_BY_GEOMETRY_SHADER seen in ARB_program_interface_query
		//GL_REFERENCED_BY_TESS_CONTROL_SHADER seen in ARB_program_interface_query
		//GL_REFERENCED_BY_TESS_EVALUATION_SHADER seen in ARB_program_interface_query
		//GL_REFERENCED_BY_VERTEX_SHADER seen in ARB_program_interface_query
		//GL_SAMPLER seen in KHR_debug
		//GL_SHADER seen in KHR_debug
		//GL_SHADER_IMAGE_ATOMIC seen in ARB_internalformat_query2
		//GL_SHADER_IMAGE_LOAD seen in ARB_internalformat_query2
		//GL_SHADER_IMAGE_STORE seen in ARB_internalformat_query2
		#define GL_SHADER_STORAGE_BARRIER_BIT    0x00002000
		//GL_SHADER_STORAGE_BLOCK seen in ARB_program_interface_query
		#define GL_SHADER_STORAGE_BUFFER         0x90D2
		#define GL_SHADER_STORAGE_BUFFER_BINDING 0x90D3
		#define GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT 0x90DF
		#define GL_SHADER_STORAGE_BUFFER_SIZE    0x90D5
		#define GL_SHADER_STORAGE_BUFFER_START   0x90D4
		//GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_TEST seen in ARB_internalformat_query2
		//GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_WRITE seen in ARB_internalformat_query2
		//GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST seen in ARB_internalformat_query2
		//GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE seen in ARB_internalformat_query2
		//GL_SRGB_READ seen in ARB_internalformat_query2
		//GL_SRGB_WRITE seen in ARB_internalformat_query2
		//GL_STENCIL_COMPONENTS seen in ARB_internalformat_query2
		//GL_STENCIL_RENDERABLE seen in ARB_internalformat_query2
		//GL_TESS_CONTROL_SUBROUTINE seen in ARB_program_interface_query
		//GL_TESS_CONTROL_SUBROUTINE_UNIFORM seen in ARB_program_interface_query
		//GL_TESS_CONTROL_TEXTURE seen in ARB_internalformat_query2
		//GL_TESS_EVALUATION_SUBROUTINE seen in ARB_program_interface_query
		//GL_TESS_EVALUATION_SUBROUTINE_UNIFORM seen in ARB_program_interface_query
		//GL_TESS_EVALUATION_TEXTURE seen in ARB_internalformat_query2
		//GL_TEXTURE_BUFFER_OFFSET seen in ARB_texture_buffer_range
		//GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT seen in ARB_texture_buffer_range
		//GL_TEXTURE_BUFFER_SIZE seen in ARB_texture_buffer_range
		//GL_TEXTURE_COMPRESSED_BLOCK_HEIGHT seen in ARB_internalformat_query2
		//GL_TEXTURE_COMPRESSED_BLOCK_SIZE seen in ARB_internalformat_query2
		//GL_TEXTURE_COMPRESSED_BLOCK_WIDTH seen in ARB_internalformat_query2
		//GL_TEXTURE_GATHER seen in ARB_internalformat_query2
		//GL_TEXTURE_GATHER_SHADOW seen in ARB_internalformat_query2
		//GL_TEXTURE_IMAGE_FORMAT seen in ARB_internalformat_query2
		//GL_TEXTURE_IMAGE_TYPE seen in ARB_internalformat_query2
		//GL_TEXTURE_IMMUTABLE_LEVELS seen in ARB_texture_view
		//GL_TEXTURE_SHADOW seen in ARB_internalformat_query2
		//GL_TEXTURE_VIEW seen in ARB_internalformat_query2
		//GL_TEXTURE_VIEW_MIN_LAYER seen in ARB_texture_view
		//GL_TEXTURE_VIEW_MIN_LEVEL seen in ARB_texture_view
		//GL_TEXTURE_VIEW_NUM_LAYERS seen in ARB_texture_view
		//GL_TEXTURE_VIEW_NUM_LEVELS seen in ARB_texture_view
		//GL_TOP_LEVEL_ARRAY_SIZE seen in ARB_program_interface_query
		//GL_TOP_LEVEL_ARRAY_STRIDE seen in ARB_program_interface_query
		//GL_TRANSFORM_FEEDBACK_VARYING seen in ARB_program_interface_query
		//GL_TYPE seen in ARB_program_interface_query
		//GL_UNIFORM seen in ARB_program_interface_query
		//GL_UNIFORM_BLOCK seen in ARB_program_interface_query
		#define GL_UNIFORM_BLOCK_REFERENCED_BY_COMPUTE_SHADER 0x90EC
		#define GL_VERTEX_ATTRIB_ARRAY_LONG      0x874E
		//GL_VERTEX_ATTRIB_BINDING seen in ARB_vertex_attrib_binding
		//GL_VERTEX_ATTRIB_RELATIVE_OFFSET seen in ARB_vertex_attrib_binding
		//GL_VERTEX_BINDING_DIVISOR seen in ARB_vertex_attrib_binding
		//GL_VERTEX_BINDING_OFFSET seen in ARB_vertex_attrib_binding
		//GL_VERTEX_BINDING_STRIDE seen in ARB_vertex_attrib_binding
		//GL_VERTEX_SUBROUTINE seen in ARB_program_interface_query
		//GL_VERTEX_SUBROUTINE_UNIFORM seen in ARB_program_interface_query
		//GL_VERTEX_TEXTURE seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_128_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_16_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_24_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_32_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_48_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_64_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_8_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_96_BITS seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_BPTC_FLOAT seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_BPTC_UNORM seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_RGTC1_RED seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_RGTC2_RG seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_S3TC_DXT1_RGB seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_S3TC_DXT1_RGBA seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_S3TC_DXT3_RGBA seen in ARB_internalformat_query2
		//GL_VIEW_CLASS_S3TC_DXT5_RGBA seen in ARB_internalformat_query2
		//GL_VIEW_COMPATIBILITY_CLASS seen in ARB_internalformat_query2
		...
		// Extension: APPLE_texture_range
		extern void (CODEGEN_FUNCPTR *_ptrc_glGetTexParameterPointervAPPLE)(GLenum target, GLenum pname, GLvoid ** params);
		#define glGetTexParameterPointervAPPLE _ptrc_glGetTexParameterPointervAPPLE
		extern void (CODEGEN_FUNCPTR *_ptrc_glTextureRangeAPPLE)(GLenum target, GLsizei length, const GLvoid * pointer);
