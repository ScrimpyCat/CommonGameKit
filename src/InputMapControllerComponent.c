...
{
    CCComponentRegister(CC_INPUT_MAP_CONTROLLER_COMPONENT_ID, CCInputMapControllerComponentName, CC_STD_ALLOCATOR, sizeof(CCInputMapControllerComponentClass), CCInputMapControllerComponentInitialize, CCInputMapControllerComponentDestroy);
}
