...
{
    CCComponentRegister(CC_INPUT_MAP_MOUSE_BUTTON_COMPONENT_ID, CCInputMapMouseButtonComponentName, CC_STD_ALLOCATOR, sizeof(CCInputMapMouseButtonComponentClass), CCInputMapMouseButtonComponentInitialize, CCInputMapComponentDestroy);
}
