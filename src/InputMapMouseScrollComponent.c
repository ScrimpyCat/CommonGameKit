...
{
    CCComponentRegister(CC_INPUT_MAP_MOUSE_SCROLL_COMPONENT_ID, CCInputMapMouseScrollComponentName, CC_STD_ALLOCATOR, sizeof(CCInputMapMouseScrollComponentClass), CCInputMapMouseScrollComponentInitialize, CCInputMapComponentDestroy);
}
